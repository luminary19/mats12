...
`experiment.generate_second_order_20k` is the frozen single-RTX-PRO-6000-Workstation second-order pipeline. Adapter/base loading and user-only prompt rendering come only from `evaluate_llama_adapter.py`; immutable layout, length sort, tokenizer padding, decode, allocator cleanup, seed reset, resume, and original-order export semantics are bound to `generate_teacher_20k.py` (source SHA-256 `20334a6d1f3c3140f6ea359eb33f49f2e55a218067d2b26f8553f765ae199811`). It validates the authoritative 20,000-row input SHA-256 `b404c94e81510d5b17e3f04df38d7905aa639cbe0343db0fc925a317164dee90`, renders/tokenizes all prompts into one immutable layout, processes deterministic `(input_tokens, original_index)` work, and restores original order for the final five-key corpus.
...
.\scripts\generate-second-order-20k.ps1 -Monitor -BatchSize 256 -RunRoot /workspace/runs/second-order-llama-20k-YYYYMMDDTHHMMZ -InputPath /workspace/runs/abliterated-20000-20260829T022737Z/output/rollouts.jsonl -Checkpoint /workspace/runs/llama-abliterated-seed42-1ep-20260829T051410Z/checkpoints/step-000157 -StagingManifest /workspace/runs/model-staging-provenance-20260826T2347Z/model-manifest.json
.\scripts\generate-second-order-20k.ps1 -Finalize -BatchSize 256 -RunRoot /workspace/runs/second-order-llama-20k-YYYYMMDDTHHMMZ -InputPath /workspace/runs/abliterated-20000-20260829T022737Z/output/rollouts.jsonl -Checkpoint /workspace/runs/llama-abliterated-seed42-1ep-20260829T051410Z/checkpoints/step-000157 -StagingManifest /workspace/runs/model-staging-provenance-20260826T2347Z/model-manifest.json
```
