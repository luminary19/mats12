...
function Quote-Remote([string]$Value) { if ([string]::IsNullOrWhiteSpace($Value) -or $Value -match '[\x00-\x1f]') { throw 'Unsafe remote argument.' }; return ConvertTo-PosixSingleQuoted $Value }
