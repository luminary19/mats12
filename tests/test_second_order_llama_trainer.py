...
class SecondOrderTrainerContractTests(unittest.TestCase):
    ...
    def test_parser_and_scripts_are_ascii_and_lifecycle_separated(self):
        ...
        self.assertIn("Copy-FileToPod -Pod $pod", launcher)
        self.assertIn("return Invoke-PodSsh $pod \"bash $remoteQuoted", launcher)
        self.assertNotIn("return Invoke-PodSsh $pod $template", launcher)
